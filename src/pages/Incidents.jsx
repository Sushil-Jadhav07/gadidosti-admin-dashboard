      ...
      {loading ? (
        ...
        <div className="card overflow-hidden">
          <div className="px-5 pt-4 pb-4 flex flex-wrap items-center justify-between gap-3">
            <h3 className="text-base font-poppins font-semibold text-secondary">Incidents</h3>
            ...
            <table className="data-table">
              ...
              <tbody>
                {paginated.map((incident) => (
                  <tr key={incident.id}>
                    <td className="font-medium text-neutral-800 whitespace-nowrap">{bookingRef(incident)}</td>
                    <td>
                    ...
                    <td className="whitespace-nowrap">{new Date(incident.reportedAt).toLocaleString('en-IN')}</td>
